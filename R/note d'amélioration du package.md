...
- [ ] Créer une vignette (tutoriel complet) illustrant le workflow de A à Z (de l'imputation à l'export Word).
- [ ] Ajouter des tests statistiques de comparaison de moyennes (T-test, ANOVA) dans `descr_by_group`.
