...
# Embarquée dans le package analytix — lancement via analytix::run_gui()
...
if (requireNamespace("analytix", quietly = TRUE)) library(analytix)
...
ui <- bslib::page_navbar(
  ...
  bslib::nav_panel(
    ...
    icon = safe_icon("calculator-fill", fa_fallback = "calculator"),
  ...
  # --- Onglet 8 : Éditeur de Rapport ---
  bslib::nav_panel(
    title = "📝 Éditeur de Rapport",
    icon = safe_icon("journal-text", fa_fallback = "edit"),
    mod_report_editor_ui("report_editor_module")
  ),
  ...
  nav_item(
    tags$a(
      href = "https://github.com/elidpremier/analytix",
      target = "_blank",
